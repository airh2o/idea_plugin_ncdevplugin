...
public final class Notifications {
    ...
    public static void showException(final Project project,
                                     final Throwable t) {
        LOG_ONLY_GROUP
                .createNotification(titleFor(t), messageFor(t), ERROR, null)
                .setListener(URL_OPENING_LISTENER)
                .notify(project);
    }
    ...
    private static String messageFor(final Throwable t) {
        ...
        if (t.getCause() != null) {
            return message("checkstyle.exception-with-root-cause" + detailSuffix, t.getMessage(),
                    traceOf(rootCauseOf(t)));
        }
