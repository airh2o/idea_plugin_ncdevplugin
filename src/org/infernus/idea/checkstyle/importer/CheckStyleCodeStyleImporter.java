...
public class CheckStyleCodeStyleImporter
    ...
    @Override
    public @Nullable
    CodeStyleScheme importScheme(@NotNull final Project project,
        ...
        try {
            ...
            if (configuration != null) {
                importConfiguration(checkstyleProjectService(project), configuration,
                        targetScheme.getCodeStyleSettings());
                return targetScheme;
            }
        } catch (Exception e) {
