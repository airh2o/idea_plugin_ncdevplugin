 ...
 * @Version
 */
public class SimpleListJBTable<T extends CircularlyAccessibleValueObject> extends BaseSimpleListTable {
    List<T> rows;
    ArrayList<MsgTableDialogColumnDTO> mcs;

    public SimpleListJBTable() {
        this(null);
    }

    public SimpleListJBTable(List<T> rows) {
        super();
    ...
    public void initTable() {
        ...
        for (int i = 0; i < mcs.size(); ++i) {
            m.addColumn(mcs.get(i).getTitle());
        }
