 ...
 * @Version
 */
public class Nc6xSelectRootXmlPathListener implements ActionListener {
    private ResetNCUserPassWordPanel panel;

    public Nc6xSelectRootXmlPathListener(ResetNCUserPassWordPanel panel) {
        this.panel = panel;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        panel.textField_nc6x_rootuserXmlPath.setText(file.getAbsolutePath());

        panel.reloadNc6RootXml();
    }
}
