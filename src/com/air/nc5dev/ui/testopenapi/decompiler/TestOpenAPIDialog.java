 ...
 */
@Data
public class TestOpenAPIDialog extends DialogWrapper {
    ...
    public TestOpenAPIDialog(Project project) {
        super(project);
            ...
            textFieldSerach.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (e.getID() != MouseEvent.BUTTON1) {
                        ...
                        JMenuItem item = new JMenuItem((getDecompilerUtil().isAutoLogScr() ? "关闭" : "打开 ") + "自动滚动");
                        popup.add(item);
                        item.addActionListener(event -> {
                            getDecompilerUtil().setAutoLogScr(!getDecompilerUtil().isAutoLogScr());
                        });
    ...
    public static class MySelectFileTableMouseAdpaterImpl extends MouseAdapter {
        TestOpenAPIDialog patcherDialog;
        JTable table;
