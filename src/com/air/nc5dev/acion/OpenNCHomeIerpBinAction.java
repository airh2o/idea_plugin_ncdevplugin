...
public class OpenNCHomeIerpBinAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        try {
            ...
            File dirToOpen = new File(ProjectNCConfigUtil.getNCHomePath() + File.separatorChar + "ierp" + File.separatorChar + "bin");
