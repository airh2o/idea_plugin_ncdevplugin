 ...
 **/
public class LogMoveUpAction extends AbstractIdeaAction {
    public LogMoveUpAction(String name, String desc, Icon icon) {
        super(name, desc, icon);
    }
    public LogMoveUpAction() {
        super();
    }
    ...
    public void doHandler(AnActionEvent e) {
        ...
        LogMoveDownAction.setAuto(false);
    }
}
