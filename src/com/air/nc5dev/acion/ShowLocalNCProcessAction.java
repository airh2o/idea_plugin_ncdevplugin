...
import com.air.nc5dev.ui.compoment.SimpleDialog;
import com.air.nc5dev.ui.compoment.SimpleListJBTable;
import com.air.nc5dev.util.IoUtil;
import com.air.nc5dev.util.ProjectNCConfigUtil;
import com.air.nc5dev.util.idea.LogUtil;
import com.air.nc5dev.util.idea.ProjectUtil;
import com.air.nc5dev.vo.NCProcesserVO;
...
public class ShowLocalNCProcessAction extends AbstractIdeaAction {
    ...
    protected void doHandler(AnActionEvent e) throws IOException {
        ...
        exec.destroy();
        final ArrayList<NCProcesserVO> list = new ArrayList<>(100);
        outs.forEach(line -> {
            if (line.contains("ufmiddle.start.tomcat.StartDirectServer")) {
                ...
                list.add(NCProcesserVO.builder()
                        .type("服务端")
        ...
        if (list.isEmpty()) {
            ...
            new SimpleDialog(e.getProject(), "找到的本机相关NC进程列表"
                    , SimpleListJBTable.of(list)
            ).show();
        }
    }
}
